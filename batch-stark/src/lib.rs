...
//!
//! ```ignore
//! use p3_batch_stark::{prove_batch, verify_batch, ProverOnlyData, StarkInstance};
//!
//! let instances = vec![
...
//! ];
//!
//! let prover_data = ProverOnlyData::from_instances(&config, &instances);
//! let proof = prove_batch(&config, &instances, &prover_data);
//! verify_batch(&config, &[air1, air2], &proof, &[pv1, pv2], &prover_data.common)?;
//! ```
...
pub use common::{CommonData, ProverOnlyData, get_perm_challenges};
pub use config::{
